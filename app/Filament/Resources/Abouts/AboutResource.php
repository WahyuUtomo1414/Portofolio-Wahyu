...
class AboutResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Profil Utama';

    protected static ?string $modelLabel = 'Profil Utama';

    protected static ?string $pluralModelLabel = 'Profil Utama';
