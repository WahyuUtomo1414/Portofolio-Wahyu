        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div class="lg:col-span-5 bg-[#FAF8F5] border-neo p-6 sm:p-8 rounded-lg shadow-neo space-y-6">
                ...
                <div class="space-y-4 font-mono text-sm">
                    ...
                    <!-- Email -->
                    <a href="mailto:{{ $profile['email'] }}" class="flex items-center gap-3.5 p-3.5 bg-white border-neo rounded-md shadow-neo-sm hover:shadow-neo transition-all">
                        ...
                        <div class="truncate">
                            ...
                            <div class="font-bold text-[#0F172A] text-xs sm:text-sm truncate">{{ $profile['email'] }}</div>
                        </div>
                    </a>

                    <!-- WhatsApp -->
                    <a href="{{ $profile['social_whatsapp'] }}" target="_blank" rel="noopener noreferrer" class="flex items-center gap-3.5 p-3.5 bg-white border-neo rounded-md shadow-neo-sm hover:shadow-neo transition-all">
                        ...
                        <div>
                            ...
                            <div class="font-bold text-[#0F172A] text-xs sm:text-sm">{{ $profile['no_wa'] }}</div>
                        </div>
                    </a>
                    ...
                    <div class="flex items-center gap-3.5 p-3.5 bg-white border-neo rounded-md shadow-neo-sm">
                        ...
                        <div>
                            ...
                            <div class="font-bold text-[#0F172A] text-xs sm:text-sm">{{ $profile['location'] }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pt-4 border-t border-slate-300 font-mono">
                    ...
                    <div class="flex flex-wrap gap-2.5 text-xs font-bold">
                        <a href="{{ $profile['social_github'] }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-white text-[#0F172A] border-neo px-3 py-2 rounded shadow-neo-sm hover:bg-[#2563EB] hover:text-white transition-all">
                        ...
                        <a href="{{ $profile['social_linkedin'] }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-white text-[#0F172A] border-neo px-3 py-2 rounded shadow-neo-sm hover:bg-[#2563EB] hover:text-white transition-all">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
                        ...
                        <a href="{{ $profile['social_instagram'] }}" target="_blank" rel="noopener" class="inline-flex items-center gap-2 bg-white text-[#0F172A] border-neo px-3 py-2 rounded shadow-neo-sm hover:bg-[#2563EB] hover:text-white transition-all">
                            <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24">
